 ...
 */
public class XMLoader extends TextInputFormat {

 
  private static final Logger log =  LoggerFactory.getLogger(XMLoader.class);
  ...
  public static class XmlRecordReader extends RecordReader<LongWritable, Text> {
    ...
    public XmlRecordReader(FileSplit split, Configuration conf) throws IOException {
      ...
      System.out.println("Reading the Record Readers");
